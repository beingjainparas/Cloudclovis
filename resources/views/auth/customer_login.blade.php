...
@section('content')
    <form method="POST" action="{{ url('/login') }}">
        ...
        <div class="form-group">
            ...
            <!-- <small><a href="{{ url('password/request') }}">Forgot password?</a></small> -->

        </div>

        <button type="submit" class="btn_1 full-width add_top_60">Login to CloudClovis</button>
        <div class="text-center add_top_10">New to CloudClovis? <strong><a href="{{ url('/register') }}">Sign up!</a></strong></div>
    </form>
